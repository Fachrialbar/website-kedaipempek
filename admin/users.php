			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $row['username'] ?></td>
						<td align="center">
							<a href="users_edit.php?id=<?= $row['idusers'] ?>" class="btn" title="Edit data"><i class="fa fa-edit"></i></a>
							<a href="?delete=<?= $row['idusers'] ?>" class="btn" onclick="return confirm('Yakin ?')" title="Hapus data"><i class="fa fa-times"></i></a>
						</td>
					</tr>
					<?php }}else{ ?>
					<tr>
